...
OPENSSL_ENGINE_PATH=$(find /usr/lib -name "libzk_pkcs11.so" | head -n 1)
...
OPENSSL_ENGINE_NAME=libzk_pkcs11.so
OPENSSL_ENGINE_PATH=$(find /usr/lib -name "$OPENSSL_ENGINE_NAME" | head -n 1)
